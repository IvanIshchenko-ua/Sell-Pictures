...
exports.normalizeOrderInput = exports.validateOrderInput = exports.validatePaintingInput = exports.normalizePaintingInput = void 0;
const normalizeText = (value, maxLength) => {
    if (typeof value !== "string")
        return "";
    return value.trim().slice(0, maxLength);
};
const normalizePaintingInput = (payload) => {
    const data = (payload ?? {});
    return {
...
exports.normalizePaintingInput = normalizePaintingInput;
const validatePaintingInput = (payload) => {
    const data = (0, exports.normalizePaintingInput)(payload);
    if (!data.title)
        return { ok: false, message: "Назва є обов'язковою" };
...
exports.validatePaintingInput = validatePaintingInput;
const validateOrderInput = (payload) => {
    ...
    if (!customerName)
        return { ok: false, message: "Ім'я клієнта є обов'язковим" };
